@php
    ...
    $kelas_all = \app\Models\kelas::all();
@endphp
...
<dialog id="my_modal_{{ $ranId }}" class="modal p-0 m-0">
    <div class="modal-box">
                    ...
                    <label class="form-control w-full"> 
                        ...
                        <select required name="jurusan" class="select select-sm select-bordered w-full">
                            ...
                            @foreach ($jurusans as $item)
                                <option value="{{ $item->id_jurusan }}" {{ $jurusan == $item->id_jurusan ? 'selected' : '' }}>{{ $item->jurusan }}</option>
                            @endforeach
                        </select>
                    </label>
                    <label class="form-control w-full"> 
                        ...
                        <select required name="kelas" class="select select-sm select-bordered w-full">
                            ...
                            @foreach ($kelas_all as $item)
                                <option value="{{ $item->id_kelas }}" {{ $kelas == $item->id_kelas ? 'selected' : '' }}>{{ $item->kelas }}</option>
                            @endforeach
                        </select>
                    </label>
                    <label class="form-control w-full"> 
