<button class="btn btn-sm btn-success text-white"  onclick="my_modal_{{ $id_sesi }}.showModal()">
...
<dialog id="my_modal_{{ $id_sesi }}" class="modal p-0 m-0">
    <div class="modal-box">
            ...
            <div class="flex flex-row flex-wrap gap-3">
                ...
                <div class="flex-grow">
                    ...
                    <label class="form-control w-full"> 
                        ...
                        <input type="time" placeholder="Type here" class="input input-sm input-bordered w-full" />
                    </label>
                    <label class="form-control w-full"> 
                        <div class="label">
