<button class="btn btn-sm btn-success text-white"  onclick="my_modal_{{ $id_mapel }}.showModal()">
...
<dialog id="my_modal_{{ $id_mapel }}" class="modal p-0 m-0">
    <div class="modal-box">
        <div class="modal-action w-full flex justify-between p-0 m-0">
            <h3 class="font-bold text-lg">Edit Akun {{ $mapel }}</h3>
            <form method="dialog">
        ...
        <form class="mt-3">
            <div class="flex flex-row flex-wrap gap-3">
                ...
                <div class="flex-grow">
                    <label class="form-control w-full"> 
                        <div class="label">
                            <span class="label-text font-bold">Nama Guru</span>
                        </div>
                        <input type="text" placeholder="Type here" class="input input-sm input-bordered w-full" />
                    </label>
                    <label class="form-control w-full"> 
                        <div class="label">
                            <span class="label-text font-bold">NIP</span>
                        </div>
                        <input type="text" placeholder="Type here" class="input input-sm input-bordered w-full" />
                    </label>
                    <label class="form-control w-full"> 
