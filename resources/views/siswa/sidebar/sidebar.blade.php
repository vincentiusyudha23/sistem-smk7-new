<div class="w-[20%] h-screen bg-blue-700 p-3 text-white fixed z-10 left-0 top-0">
    ...
    <ul class="flex flex-col gap-3 mt-5 px-3">
        <li>
            <a href="{{ route('siswa.dashboard') }}" class=" py-1 flex flex-row justify-start items-center btn btn-ghost">
        ...
        <li>
            <a href="{{ route('siswa.ujian') }}" class=" py-1 flex flex-row justify-start items-center btn btn-ghost">
        ...
        <li>
            <a href="{{ route('siswa.presensi') }}" class=" py-1 flex flex-row justify-start items-center btn btn-ghost">
    ...
    <a href="{{ route('siswa.login') }}" class="btn btn-ghost btn-sm absolute bottom-5 right-3">
