                ...
                @foreach ($siswas as $siswa)
                    <tr>
                        ...
                        <td>
                            ...
                            <x-admin-edit-siswa 
                                :ranId="$siswa->id_siswa"
                                :siswa="$siswa->nama"
                                :username="$siswa->users->username"
                                ...
                                :nomorOrangtua="$siswa->orangTua->nomor_telepon"
                                />
                                
                            <a class="btn btn-sm btn-error text-white btn-delete-siswa" data-id="{{ $siswa->id_siswa }}">
