<div id="modal-sesiedit-container">
    @php
                ...
                <div class="flex flex-row flex-wrap gap-3">
                    ...
                    <div class="flex-grow">
                        <label class="form-control w-full"> 
                            ...
                            <input required type="date" name="tanggal_ujian" value="{{ $item['tanggal'] }}" class="input input-sm input-bordered w-full" />
                        </label>
                        <label class="form-control w-full"> 
                            <div class="label">
                                <span class="label-text font-bold">Kelas</span>
                            </div>
                            <select required class="js-example-basic-multiple2 w-full" name="kelas[]" multiple="multiple">
